...
class Morador_Avisos_Pagina_Inicial_Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_morador_avisos_pagina_inicial)

        findViewById<Button>(R.id.buttonMinhasReservas).setOnClickListener{
            val intent = Intent(this,Morador_Avisos_Historico_Activity::class.java)
