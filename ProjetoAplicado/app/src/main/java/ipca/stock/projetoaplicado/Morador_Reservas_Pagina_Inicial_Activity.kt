...
class Morador_Reservas_Pagina_Inicial_Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_morador_reservas_pagina_inicial)

        findViewById<Button>(R.id.buttonMinhasReservas).setOnClickListener{
            val intent = Intent(this,Morador_Reservas_Historico_Activity::class.java)
            startActivity(intent)
        }

        findViewById<Button>(R.id.buttonNovaReserva).setOnClickListener{
            val intent = Intent(this,Morador_Reservas_Nova_Reserva_Activity::class.java)
            startActivity(intent)
        }
